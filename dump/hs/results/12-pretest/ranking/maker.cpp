...
int main(int argc, char const *argv[])
{
  ...
  cout << "<tr><td>Rank</td><td>Roll</td><td>Name</td><td>Bangla 1st paper</td><td>English 2nd paper</td><td>Biology 1st paper</td><td>Biology 2nd paper</td><td>Physics 2nd paper</td><td>Chemistry 2nd paper</td><td>Higher Math 2nd paper</td><td>ICT</td><td>Total</td><td>GPA</td></tr>" << endl;
  for(student one : all) {
    cout << "<tr>";
    cout << wrapTD(++rank);
